...
public class Post_view extends AppCompatActivity {
    ...
    String eventname,discription,postimage1,databaseuseid,username,htno;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        String email="incubeagi@gmail.com";
                                            ...
                                            regref.child(currentuserid).setValue(true).addOnCompleteListener(new OnCompleteListener<Void>() {
                                                ...
                                                public void onComplete(@NonNull Task<Void> task) {
                                                    if(task.isSuccessful())
                                                    {
                                                        ...
                                                        map.put("htno",htno);
                                                        reference.child(postkey).updateChildren(map).addOnCompleteListener(new OnCompleteListener() {
                                                            @Override
                                                            public void onComplete(@NonNull Task task) {
